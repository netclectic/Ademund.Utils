...
namespace Ademund.Utils
{
	...
	{
		public static string FullyQualifiedComputerName()
		{
		...
		public static PhysicalAddress GetMacAddress()
		{
            return NetworkInterface.GetAllNetworkInterfaces()
				...
				.FirstOrDefault() ?? PhysicalAddress.Parse("000000000000");
		}

		public static string GetIPAddress()
		{
			string ipaddress = "127.0.0.1";
			var unicastAddress = NetworkInterface.GetAllNetworkInterfaces()
				.Where(x => x.OperationalStatus == OperationalStatus.Up)
				.SelectMany(x => x.GetIPProperties().UnicastAddresses)
				.Where(x => x.DuplicateAddressDetectionState == DuplicateAddressDetectionState.Preferred)
				.FirstOrDefault(x => x.AddressPreferredLifetime != uint.MaxValue);
	...
	/// </summary>
	public sealed class NetworkShareAccesser : IDisposable
	{
