...
namespace Ademund.Utils.ListExtensions
{
    public static class ListExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="T">The array of the array.</typeparam>
        /// <param name="array">The list to split.</param>
        /// <param name="size">The size of the smaller arrays.</param>
        /// <returns>An array containing smaller arrays.</returns>
        public static IEnumerable<IEnumerable<T>> Split<T>(this T[] list, int size)
        {
            for (int i = 0; i < (float)list.Length / size; i++)
            {
        ...
        {
            for (int i = 0; i < (float)list.Count / size; i++)
            {
                yield return list.Skip(i * size).Take(size);
            }
        }
