...
namespace Ademund.Utils
{
    public static class MimeType
    {
		...
		public static string GetExtension(string MimeType, string Default="bin")
		{
		...
		public static List<string> GetNonHtmlExtensions()
		{
			return MIMETypesDictionary
				.Where(x => !Regex.IsMatch(x.Value, @"(text)|\W(html|xml|json)", RegexOptions.IgnoreCase))
				.Select(x => x.Key)
				.ToList();
		}
		...
		{
			return MIMETypesDictionary.FirstOrDefault(oo => oo.Value.ToLowerInvariant() == MimeType.ToLowerInvariant());
		}
